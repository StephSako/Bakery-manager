...
public class Restaurant {
	...
	public String afficherStock() {
		...
		for (Produit produit : stock) {
			stockToPrint += "'" + produit.nom + "' - " + df.format((produit.prix * 1.1)) + "Ä TTC - " + produit.stock + " en stock\n";
		}
		return stockToPrint;
	}
	...
	public String donneesComptable() {
		String donnees = "";
		donnees += "Total des rentrÈes d'argent : "+rentreeArgent+"\nTotal de la TVA facturÈe : "+totalTVAfacturee; 
		return donnees;
	}
}
