...
java -cp "../../restaurant/bin:../lib/*:../../logger/bin:" junit.textui.test.RunTest -junit3 test.TestNoteClient
java -cp "../../restaurant/bin:../lib/*:../../logger/bin:" junit.textui.test.RunTest -junit3 test.TestRestaurant
